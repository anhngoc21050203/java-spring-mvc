    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <div class="container-fluid page-header py-5 bg-dark">
            <div class="container text-center">
                <h1 class="text-white display-6 mb-4">Shop Detail</h1>
            ...
            <div class="container py-5">
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                        <img src="/images/single-item.jpg" class="img-fluid rounded" alt="Image">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="tab-content mb-5">
                                    ...
                                    <div class="tab-pane" id="nav-mission" role="tabpanel"
                                        ...
                                        <div class="d-flex">
                                            <img src="/images/avatar.jpg" class="img-fluid rounded-circle p-3"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="rounded" style="width: 100px; height: 100px;">
                                        <img src="/images/featur-1.jpg" class="img-fluid rounded" alt="Image">
                                    </div>
                                    <div>
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="rounded me-4" style="width: 100px; height: 100px;">
                                        <img src="/images/vegetable-item-4.jpg" class="img-fluid rounded" alt="">
                                    </div>
                                    <div>
                                        <h6 class="mb-2">Big Banana</h6>
                                        <div class="d-flex mb-2">
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="rounded me-4" style="width: 100px; height: 100px;">
                                        <img src="/images/vegetable-item-5.jpg" class="img-fluid rounded" alt="">
                                    </div>
                                    <div>
                                        <h6 class="mb-2">Big Banana</h6>
                                        <div class="d-flex mb-2">
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="rounded me-4" style="width: 100px; height: 100px;">
                                        <img src="/images/vegetable-item-6.jpg" class="img-fluid rounded" alt="">
                                    </div>
                                    <div>
                                        <h6 class="mb-2">Big Banana</h6>
                                        <div class="d-flex mb-2">
                ...
                <div class="vesitable">
                    <div class="owl-carousel vegetable-carousel justify-content-center">
                        ...
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="/images/vegetable-item-3.png" class="img-fluid w-100 rounded-top bg-light"
                                    alt="">
                            </div>
                            <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                style="top: 10px; right: 10px;">Vegetable</div>
